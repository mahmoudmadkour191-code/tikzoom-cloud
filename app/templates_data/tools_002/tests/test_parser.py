...
def test_pick_newest_archive_path():
    from vadana.connect import pick_newest_archive_path
    xml = ("""<results><status code="ok"/><scos>
<sco sco-id="52301469" icon="archive"><name>s1</name><url-path>/lwl8uv82re3w/</url-path></sco>
<sco sco-id="52309999" icon="archive"><name>s2</name><url-path>/abc123xyz/</url-path></sco>
<sco sco-id="52301000" icon="folder"><name>nopath</name></sco>
</scos></results>""")
    assert pick_newest_archive_path(xml) == "abc123xyz"
    assert pick_newest_archive_path("<results><scos></scos></results>") is None
